...
useEffect(()=>{
  ...
  return (
    <Box boxShadow= "rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset"
     w={{ base: "full",  lg: "25%" }} color="white">
          ...
          >
            <Text>Sub Total</Text>
            {discount>0?<Text as={"s"} color={"red.400"}>RS {totalPrice}/-</Text>:<Text color={"green.500"}>RS {totalPrice}/-</Text>}
          </HStack>
          {discount>0 && <HStack
            p={5}
            justifyContent={"space-between"}
         ...
         {discount>0 &&  <HStack
          ...
          <Stack
            ...
            justifyContent={"space-between"}
          >
           <Button fontWeight={"bold"} colorScheme='teal' onClick={getPromocode}>Get Promocode</Button>
          ...
          <HStack   fontWeight="semibold" p={5}>
            <Input
             ...
             value={inputText}
            />
            <Button colorScheme='blue' onClick={getDiscount}>Apply</Button>
          </HStack>
          <Divider orientation="horizontal" />
          <Box
          ...
          >
            ...
            <Button onClick={()=>handleClearCart()}  colorScheme='red'>Clear cart</Button>
          </Stack>
        </Box>
  )
}
