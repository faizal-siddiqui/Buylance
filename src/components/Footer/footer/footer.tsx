  ...
  return (
    ...
    >
      <Container as={Stack} maxW={"8xl"} py={5}>
        ...
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4, lg: 6 }} spacing={8}>
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>
              Terms & Conditions of <br /> Membership Program
            </Link>
      ...
      >
        ...
        >
          <Text>
            © 2018 Madura Fashion & Lifestyle A Division of Aditya Birla Fashion
            & Retail Limited. All rights reserved.
          </Text>
          <Stack direction={"row"} spacing={6}>
            <SocialButton
              label={"Facebook"}
              href={"https://www.facebook.com/Abof-111020508179123"}
            >
              <FaTwitter />
            </SocialButton>
            <SocialButton
              label={"YouTube"}
              href={"https://www.youtube.com/channel/UCl01uDTh0xy0jAzGOMjQiAQ"}
            >
              <FaYoutube />
            </SocialButton>
            <SocialButton
              label={"Instagram"}
              href={"https://www.instagram.com/abof_india/"}
            >
              <FaInstagram />
            </SocialButton>
          </Stack>
