    ...
    <div className="top-fix">
      ...
      <nav>
        <div
          className="hamburger"
          onClick={() =>
            setIsOpen({ mens: !isOpen.mens, womens: !isOpen.womens })
          }
        >
          ...
          <li>
            ...
            <div className="sub-menu">
              ...
              <div className="sub-menu-col">
                ...
                <ul>
                  <li>
                    <a href="#">3 to 10 Years</a>
                  </li>
                  <li>
                    <a href="#">11 to `16 Years</a>
                  </li>
                </ul>
              </div>
            </div>
